...
public class ProtagonistSelect : MonoBehaviour
{
	public static string protagonist = "man1";
	public static string protagonistName = "Aegis";
    ...
    public void selectProtagonist(string s)
	{
		protagonist = s;
